...
L["ReminderTip"] = "|n根据自身职业，缺少特定Buff时进行提示。|n支持耐力/智力/战斗怒吼/野性印记/心灵之火/荆棘术/雄鹰守护/强击光环/术士护甲/法师护甲/寒冬号角/正义之怒。"
...
L["Spec RaidPos"] = "主副天赋独立位置"
L["SpecRaidPosTip"] = "|n勾选后，小队及团队框体的位置，会按照你的主副天赋进行保存。"
...
L["TargetClassPower"] = "在目标姓名板上显示职业资源"
...
L["MinimapHelp"] = "鼠标滚轮可以缩放区域，鼠标中键点击打开日历。"
L["Reset Help"] = "重置帮助提示"
...
L["ShowRaidBuffTip"] = "|n点击右侧齿轮设置团队框体的法术白名单，最多同时显示3个。"
...
L["Button4"] = "侧键1"
L["Button5"] = "侧键2"
L["AutoEquip"] = "自动切换装备方案"
L["AutoEquipTip"] = "|n启用后，当你切换天赋时，若存在与该天赋同名的装备方案，则自动使用这个方案。"
L["TotemBar"] = "图腾动作条"
L["ClearHealth"] = "透明"
L["ClearClass"] = "渐变职业色"
L["PetCastbar"] = "宠物施法条"
L["ShowGroupRole"] = "显示队伍职责"
L["OffTankThreat"] = "启用副坦仇恨"
L["OffTankThreatTip"] = "|n根据队伍成员的职责，当目标仇恨在其他坦克身上时，使用自定义颜色。|n|n注意，确保你的队友们选择了正确的职责。"
L["HealPrediction"] = "显示hot治疗预估"
