...
L["/gs cleanorphans|r will loop through your macros and delete any left over GS-E macros that no longer have a sequence to match them."] = "/gse cleanorphans|r vérifie vos macros et supprime celles qui sont orphelines: c'est à dire, si elles n'ont plus de séquence."
...
L[":|r The Sequence Translator allows you to use GS-E on other languages than enUS.  It will translate sequences to match your language.  If you also have the Sequence Editor you can translate sequences between languages.  The GS-E Sequence Translator is available on curse.com"] = ":|r Le Traducteur de Macro vous permet d'utiliser GSE dans d'autres langues que l'Anglais (enUS). Il traduira les macros pour qu'elles correspondent à votre langue. Si vous disposez également de l'Editeur de Macro, vous pouvez traduire des macros dans d'autres langues. Le Traducteur de Macro de GSE est disponible sur curse.com"
...
L["Gnome Sequencer: Sequence Version Manager"] = "Gnome Sequencer: Gestionnaire de versions de macros"
...
If Priority it will try some spells more often than others.]=] ] = "Le type de boucle détermine comment votre macro s'exécute. A chaque fois que vous cliquerez sur l'icône de votre macro, GSE ira à la ligne suivante. La ligne suivante qu'il choisit varie selon cette option. Priorité : il essaiera certains sorts plus souvent que d'autres. Aléatoire : il choisira n'importe quelle ligne. Séquentiel : il passera à la ligne suivante."
...
L["was created in an older version of GSE.  It has been updated to the current version however may need to be checked manually."] = "a été créé dans une ancienne version de GSE. Elle a été mis à jour vers la version actuelle, mais une vérification pourrait quand même être nécessaire."
...
'1,2,3,1,2,3,1' means First row choose the first talent, Second row choose the second talent etc]=] ] = "Quels sont les talents préférés pour cette macro ? Chaque chiffre correspond à une rangée dans la fenêtre des talents (N). \\n'3,1,2,2,1,3,2' signifie que la première rangée a le 3ème talent sélectionné. \\nLa deuxième rangée a le 1er talent sélectionné. La 3ème rangée a le 2ème talent sélectionné, etc."
