...
L["mmColorDesc"] = "Какой цвет должен быть у текста на миникарте? (Слой 1)";
...
L["minimapLayerHoverTitle"] = "Отображение на миникарте";
L["minimapLayerHoverDesc"] = "Показывать окно номера слоя на миникарте только при наведении курсора мыши?";

L["Blackrock Mountain"] = "Черная гора";

L["soundsNpcKilledTitle"] = "Убийство NPC";
L["soundsNpcKilledDesc"] = "Проигрывать звук, когда NPC был убит для сброса таймера бафа.";

L["autoDmfBuffCharsText"] = "Настройки Ярмарки Новолуния для конкретного персонажа:";

L["middleNpcKilledTitle"] = "Убийство NPC";
L["middleNpcKilledDesc"] = "Показывать сообщение по центру экрана, когда Рунтак или Саурфанг были убиты для сброса таймера бафа.";

L["chatNpcKilledTitle"] = "Убийство NPC";
L["chatNpcKilledDesc"] = "Отправлять сообщение в чат, когда Рунтак или Саурфанг были убиты для сброса таймера бафа.";
...
L["flashNpcKilledDesc"] = "Включить моргание WoW-клиента, когда дающий баф NPC был убит?";

L["trimDataBelowLevelTitle"] = "Минимальный уровень";
L["trimDataBelowLevelDesc"] = "Укажите минимальный уровень персонажа для автоматического удаления из базы.";
