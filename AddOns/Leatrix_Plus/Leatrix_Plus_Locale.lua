...
L["If checked, you will release automatically after you die in a battleground.|n|nYou will not release automatically if you have the ability to self-resurrect."] = "勾选后，当你阵亡时会自动进行释放。|n|n如果你有复生能力，则不会进行自动释放。"
