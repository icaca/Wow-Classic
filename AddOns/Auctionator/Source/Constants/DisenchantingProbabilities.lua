...
Auctionator.Constants.DisenchantingProbability = {
  ...
  [ LE_ITEM_CLASS_WEAPON ] = {
    [ Auctionator.Constants.Rarity.UNCOMMON ] = {
      ...
      {21,25,5,4,10940,5,5,10940,5,6,10940,37.5,1,10939,37.5,2,10939,2.5,1,10998,2.5,2,10998, 5,1,10978},
      {26,30,7.5,1,11083,7.5,2,11083,37.5,1,10939,37.5,2,10939,2.5,1,11082,2.5,2,11082,5,1,11084},
