...
local C_EncounterJournal_GetSectionInfo, GetSpellInfo, GetSpellTexture, GetTime, IsSpellKnown = function() end, GetSpellInfo, GetSpellTexture, GetTime, IsSpellKnown
local EJ_GetEncounterInfo = function() end
