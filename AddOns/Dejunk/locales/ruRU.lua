...
L["AUTO_START_DESTROY_TOOLTIP"] = "Автоматически запускать процесс удаления при обнаружении удаляемых предметов."
L["AUTO_START_TEXT"] = "Автоматический старт"
...
L["CLASS_TEXT"] = "Класс"
L["CMD_ALL_ITEMS_WARNING"] = "|cFFE34F4FПРЕДУПРЕЖДЕНИЕ:|r Эта команда непостоянна. Запуск ее с большим количеством предметов может вызвать скачки частоты кадров или отключение от игры."
L["CMD_HELP_DESTROY"] = "Переключает окно удаления."
L["CMD_HELP_DESTROY_ALL"] = "Уничтожает сразу все предметы."
...
L["DESTROY_ALL_ITEMS"] = "Уничтожить все предметы"
...
L["ONLY_DESTROYING_CACHED"] = "Некоторые предметы получить не удалось. Удаление только кешированного мусора."
...
L["START_DESTROYING_GAME_VERSION_ERROR"] = "Процесс удаления можно запустить только в Classic."
