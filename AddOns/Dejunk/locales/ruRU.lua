...
L["AUTO_DESTROY_SLIDER_LABEL"] = "Экономия места"
L["AUTO_DESTROY_SLIDER_TOOLTIP"] = "Автоматически уничтожать предметы только тогда, когда остается меньше установленного количества мест в сумке.|n|nЧтобы отключить это, установите ползунок на %s."
...
L["CLASS_TEXT"] = "Класс"
L["CMD_HELP_DESTROY"] = "Начинает уничтожать предметы."
L["CMD_HELP_OPEN"] = "Начинает открывать полученные предметы."
L["CMD_HELP_SELL"] = "Начинает продавать предметы."
L["CMD_HELP_TOGGLE"] = "Переключает пользовательский интерфейс."
