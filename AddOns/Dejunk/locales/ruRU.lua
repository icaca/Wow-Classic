...
L["AUTO_OPEN_DESTROY_SLIDER_LABEL"] = "Экономия места"
L["AUTO_OPEN_DESTROY_SLIDER_TOOLTIP"] = "Автоматически открывать окно Удаления только тогда, когда остается меньше установленного количества мест в сумке.|n|nЧтобы отключить это, установите ползунок на %s."
L["AUTO_OPEN_DESTROY_TEXT"] = "Автоматическое открытие"
