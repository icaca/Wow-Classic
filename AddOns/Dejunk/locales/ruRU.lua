...
L["CANNOT_DEJUNK_WHILE_DESTROYING"] = "Невозможно разделить во время удаления предметов."
...
L["CANNOT_DESTROY_WHILE_LIST_UPDATING"] = "Невозможно удалить, пока обновляется %s."
L["CHAT_TEXT"] = "Чат"
...
L["DEJUNKING_IN_PROGRESS"] = "Удаление уже идет."
...
L["DESTROY_LIST_TOOLTIP"] = "Удалить все предметы в списке %s."
...
L["REASON_DESTROY_INCLUSIONS_TEXT"] = "Предметы в этом списке удаляются."
