...
L["BY_TYPE_TEXT"] = "按类型"
L["CANNOT_DEJUNK_WHILE_DESTROYING"] = "摧毁物品时dejunk出售功能不可用。"
L["CANNOT_DEJUNK_WHILE_LISTS_UPDATING"] = "%s和%s更新时dejunk出售功能不可用。"
L["CANNOT_DESTROY_WHILE_DEJUNKING"] = "dejunk出售物品过程中无法摧毁物品。"
L["CHAT_TEXT"] = "聊天"
L["COMMON_TEXT"] = "普通"
L["COPY_TEXT"] = "复制"
L["DEJUNK_BUTTON_TOOLTIP"] = "点击右键以切换选项。"
L["DEJUNKING_IN_PROGRESS"] = "Dejunk出售物品正在进行中。"
...
L["IGNORE_BOE_TOOLTIP"] = "忽略装绑物品。|n|n粗糙品质物品无效。"
...
L["IGNORE_SOULBOUND_TOOLTIP"] = "忽略灵魂绑定物品。|n|n粗糙品质物品无效。"
L["IGNORE_TEXT"] = "忽略"
L["IGNORE_TRADE_GOODS_TEXT"] = "制造材料"
...
L["MINIMAP_ICON_TOOLTIP_3"] = "拖动以移动此图标。"
...
L["REASON_IGNORE_TRADE_GOODS_TEXT"] = "制造业材料被忽略。"
...
L["VENDOR_DOESNT_BUY"] = "无法向商人出售那件物品。"
