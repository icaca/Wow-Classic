...
L["ITEM_WINDOW_LEFT_CLICK_TO_DESTROY"] = "Left-Click an item to destroy it."
L["ITEM_WINDOW_LEFT_CLICK_TO_SELL"] = "Left-Click an item to sell it."
L["ITEM_WINDOW_RIGHT_CLICK_TO_EXCLUDE"] = "Right-Click an item to add it to %s."
