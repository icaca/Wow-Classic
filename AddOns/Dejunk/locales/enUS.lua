...
L["CLASS_TEXT"] = "Class"
L["CMD_ALL_ITEMS_WARNING"] = "|cFFE34F4FWARNING:|r This command is volatile. Running it with a large amount of junk items may cause you to suffer frame rate spikes or a disconnection."
L["CMD_HELP_DESTROY_ALL"] = "Destroys all items at once."
...
L["DESTROY_ALL_ITEMS"] = "Destroy All Items"
...
L["START_DESTROYING_GAME_VERSION_ERROR"] = "The destroying process can only be started in Classic."
